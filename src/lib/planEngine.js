...
// ─── Cadence ────────────────────────────────────────────────────────
// A pure read over the post log — no LLM, no persistence — kept to power
// the Plan tab's single "haven't posted in a while" nudge.
...
// The best content type / best day themselves come from buildPlanSuggestion
// above; the Plan tab renders a single compact line from them rather than a
// full narrative, so no narrative builder lives here anymore.
